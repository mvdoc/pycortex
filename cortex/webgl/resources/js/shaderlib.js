var Shaderlib = (function() {
    ...
    "#endif",
        ...
        "#else",
                "vec2 cuv;",
                "float mixedData0 = mix(data0, data1, framemix);",
                // NaN check: in GLSL, NaN != NaN is true (IEEE 754)
                "bool hasNaN = (mixedData0 != mixedData0);",
            "#ifdef TWOD",
                "float mixedData2 = mix(data2, data3, framemix);",
                "hasNaN = hasNaN || (mixedData2 != mixedData2);",
                "cuv.y = (mixedData2 - vmin[1]) / (vmax[1] - vmin[1]);",
            "#endif",
                "cuv.x = (mixedData0 - vmin[0]) / (vmax[0] - vmin[0]);",
                // Set transparent color for NaN values, otherwise use colormap
                "if (hasNaN) {",
